...
describe('ESPN Homepage', () => {
    ...
    it('ESPN Homepage', async () => {

        // Go To Product Page
        await driver.get("https://espn.com");
        console.log("Visit Website")
        
        // Validate Checkout Page.
        await eyes.check(Target.window().fully().withName("Homepage").layout());
