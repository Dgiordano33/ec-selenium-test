...
describe('Visual AI Dashboard Example', () => {
    ...
    before(async () => {
        ...
        batch = new BatchInfo('Dashboard xample');
    ...
    it('Visual AI Dashboard', async () => {

        // Go To Dashboard 
        await driver.get("https://applitools-demo-dashboard-b.vercel.app/admin/dashboard");
        console.log("Visit Website")

        // Validate Dashboard
        await eyes.check(Target.window().fully().withName("Dashboard").layout());
        console.log("Validate dashboard")
        
        // click the "User Profile" button
        await driver.findElement(By.xpath("//a[text()='User Profile']")).click();

        console.log("Clicked the User Profile button successfully!");
